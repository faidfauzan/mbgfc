    ...
    <div
      ...
      <nav class="hs-accordion-group p-3 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="flex flex-col space-y-1">
          ...
          <li>
            <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('dashboard') ? 'bg-gray-100 text-blue-600' : 'text-gray-800 hover:bg-gray-100' }} text-sm rounded-lg focus:outline-none focus:bg-gray-100"
          ...
          @if (auth()->user()->role === 'member')
            <li>
              <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('matchday.member.*') ? 'bg-gray-100 text-blue-600' : 'text-gray-800 hover:bg-gray-100' }} text-sm rounded-lg focus:outline-none focus:bg-gray-100"
          ...
          {{-- Menu Khusus Captain / Admin --}}
          @if (auth()->user()->role === 'captain')
            <li>
              <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('members.*') ? 'bg-gray-100 text-blue-600' : 'text-gray-800 hover:bg-gray-100' }} text-sm rounded-lg focus:outline-none focus:bg-gray-100"
            ...
            <li>
              <a class="flex items-center gap-x-3.5 py-2 px-2.5 {{ request()->routeIs('matchdays.*') ? 'bg-gray-100 text-blue-600' : 'text-gray-800 hover:bg-gray-100' }} text-sm rounded-lg focus:outline-none focus:bg-gray-100"
