    ...
    <div class="py-6 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        ...
        <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
            ...
            <div class="mb-6">
                ...
                <p class="text-sm text-gray-500 mt-1">Daftar pertandingan yang telah dilaksanakan dan rekap
                    partisipasinya.</p>
            </div>
                        ...
                        @forelse($matchdays as $match)
                            <tr class="hover:bg-gray-50/80 transition-colors">
                                ...
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <span
                                        class="inline-flex items-center px-3 py-1 bg-emerald-50 text-emerald-700 rounded-lg text-xs font-semibold border border-emerald-200">
                                        {{ $match->total_utama }} / {{ $match->kuota }} Player
                                    </span>
                                </td>
                                <td class="px-6 py-4 font-bold text-emerald-600 whitespace-nowrap">
                                    Rp {{ number_format($match->estimasi_htm ?? 0, 0, ',', '.') }}
                                </td>
                                <td class="px-6 py-4 text-center whitespace-nowrap">
                                    <a href="{{ route('matchdays.peserta', $match->id) }}"
                                        class="inline-flex items-center text-xs bg-emerald-500 hover:bg-emerald-600 text-white px-3 py-1.5 rounded-md font-medium transition shadow-sm">
                                        Lihat Peserta
                                    </a>
                                </td>
                            </tr>
